...
const ContactController = require('../controllers/ContactController'); // Adjust the path
...
route.get('/contactDelete/:id',checkAuth,adminRole('admin'),AdminController.courseDelete)
...
//contact
route.get('/contact',ContactController.contactForm); // Route for contact page
route.post('/contact',ContactController.savecontact); // Route to handle form submission
