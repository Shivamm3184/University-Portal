...
class AdminController{
    static dashboard = async(req,res)=>{
        try {
            ...
            const contactt = await ContactModel.countDocuments();
            res.render('admin/dashboard', { n: name, i: image, e: email,  totalUsers, approvedUsers, pendingUsers, rejectedUsers, contactt })
        } catch (error) {
            console.log(error)
        }
    }
